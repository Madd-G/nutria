...
//     await _requestAndGrantLibraryPermission($);
...
// }
//
// Future<void> _requestAndGrantLibraryPermission(PatrolTester $) async {
//   if (!await Permission.mediaLibrary.isGranted) {
//     expect($(#mediaLibrary).$(#statusText).text, 'Not granted');
//     await $('Request camera permission').tap();
//     if (await $.native.isPermissionDialogVisible(timeout: _timeout)) {
//       await $.native.grantPermissionWhenInUse();
//       await $.pump();
...
//   }
//
//   expect($(#mediaLibrary).$(#statusText).text, 'Granted');
// }
//
