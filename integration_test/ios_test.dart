...
void main() async {
  ...
  testWidgets('IOS App Test', (WidgetTester tester) async {
    ...
    await tester.pumpAndSettle(const Duration(seconds: 3));
    await tester.tap(
        find.text('Water Spinach: A Delicious and Beneficial Green Vegetable'));
    ...
    await tester.dragUntilVisible(
        find.text('Apple'), fruitGrid, const Offset(0, -30));
    ...
    await tester.pumpAndSettle(const Duration(seconds: 4));
    await tester.dragUntilVisible(
        find.text('Spinach'), vegetableGrid, const Offset(0, -30));
